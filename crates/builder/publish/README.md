...
WebSocket broadcast publisher for the Unstable block builder. Accepts WebSocket connections from clients and broadcasts serialized payloads to all connected subscribers.
