    ...
    Cursor: DbCursorRO<T> + DbDupCursorRO<T>,
{
    ...
    fn is_positioned(&mut self) -> UnstableProofsStorageResult<bool> {
    ...
    fn latest_version_for_key(
        &mut self,
        key: T::Key,
    ) -> UnstableProofsStorageResult<Option<(T::Key, T::Value)>> {
    ...
    fn seek_exact(&mut self, key: T::Key) -> UnstableProofsStorageResult<Option<(T::Key, V)>> {
    ...
    fn next_live_from(
        &mut self,
        mut first_key: T::Key,
    ) -> UnstableProofsStorageResult<Option<(T::Key, V)>> {
        loop {
    ...
    fn seek(&mut self, start_key: T::Key) -> UnstableProofsStorageResult<Option<(T::Key, V)>> {
    ...
    fn next(&mut self) -> UnstableProofsStorageResult<Option<(T::Key, V)>>
    where
        T::Key: Default,
    {
