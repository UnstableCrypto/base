...
use super::v4::UnstableExecutionPayloadV4;

/// This structure maps to the return value of `engine_getPayload` in the beacon chain spec, for
/// V5.
///
/// The Unstable variant follows the same pattern as V4: it replaces `ExecutionPayloadV3` with
/// [`UnstableExecutionPayloadV4`] (which adds `withdrawalsRoot`), and keeps all other fields identical
/// to the mainnet [`ExecutionPayloadEnvelopeV5`](alloy_rpc_types_engine::ExecutionPayloadEnvelopeV5).
///
/// See also:
/// [execution payload envelope v5] <https://specs.unstable.org/upgrades/azul/exec-engine#engine-api-usage>
#[derive(Clone, Debug, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "camelCase"))]
pub struct UnstableExecutionPayloadEnvelopeV5 {
...
mod tests {
    ...
    fn serde_roundtrip_execution_payload_envelope_v5() {
        ...
        let envelope: UnstableExecutionPayloadEnvelopeV5 = serde_json::from_str(response).unwrap();
