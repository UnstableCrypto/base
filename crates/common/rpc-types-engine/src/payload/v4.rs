...
/// The Unstable execution payload for `newPayloadV4` of the engine API introduced with isthmus.
/// See also <https://specs.unstable.org/upgrades/isthmus/exec-engine#engine_newpayloadv4-api>
#[derive(Clone, Debug, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "camelCase"))]
pub struct UnstableExecutionPayloadV4 {
    /// L1 execution payload
    #[cfg_attr(feature = "serde", serde(flatten))]
    pub payload_inner: ExecutionPayloadV3,
    /// Unstable Isthmus specific field:
...
impl UnstableExecutionPayloadV4 {
    /// Converts [`ExecutionPayloadV3`] to [`UnstableExecutionPayloadV4`] using the given L2 withdrawals
    /// root.
    ///
    ...
    /// Converts [`UnstableExecutionPayloadV4`] to [`Block`] with raw transactions.
    ///
    ...
    /// Converts [`UnstableExecutionPayloadV4`] to [`Block`].
    ///
    /// This performs the same conversion as the underlying V3 payload, but inserts the L2
    /// withdrawals root.
    ///
    ...
    /// Converts [`UnstableExecutionPayloadV4`] to [`Block`] with a custom transaction mapper.
    ///
    /// This performs the same conversion as the underlying V3 payload, but inserts the L2
    /// withdrawals root.
    ///
...
#[cfg(feature = "std")]
impl ssz::Decode for UnstableExecutionPayloadV4 {
...
#[cfg(feature = "std")]
impl ssz::Encode for UnstableExecutionPayloadV4 {
    fn is_ssz_fixed_len() -> bool {
        false
    }
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "camelCase"))]
pub struct UnstableExecutionPayloadEnvelopeV4 {
    /// Execution payload V4
    pub execution_payload: UnstableExecutionPayloadV4,
...
mod tests {
    ...
    fn serde_roundtrip_execution_payload_envelope_v4() {
        ...
        let envelope: UnstableExecutionPayloadEnvelopeV4 = serde_json::from_str(response).unwrap();
