...
`base-proof` is a Unstable state transition proof SDK.
...
efficient preimage access, and `UnstableExecutor` implementing the `Executor` trait for the proof
