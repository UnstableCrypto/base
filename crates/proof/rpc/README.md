...
Shared RPC client abstractions for Unstable L1, L2, and rollup node interactions.
...
- **`L2Client`**: Querying Unstable L2 blocks, headers, proofs, and chain config.
...
backoff, shared RPC types (`UnstableBlock`, `L1BlockRef`, `L2BlockRef`, `SyncStatus`), and
