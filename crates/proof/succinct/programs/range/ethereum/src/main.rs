//! A program to verify a Unstable L2 block STF with Ethereum DA in the zkVM.
//!
//! This binary contains the client program for executing the Unstable rollup state transition
