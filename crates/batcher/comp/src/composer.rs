...
impl BatchComposer {
    /// Convert an L2 [`UnstableBlock`] into a [`SingleBatch`] and the decoded
    /// [`L1BlockInfoTx`].
    ///
...
mod tests {
    ...
    fn make_block(transactions: Vec<UnstableTxEnvelope>) -> UnstableBlock {
        UnstableBlock {
    ...
    fn test_errors(#[case] block: UnstableBlock, #[case] expected: BatchComposeError) {
