...
impl Ecotone {
    ...
    /// See: <https://specs.unstable.org/upgrades/ecotone/derivation#l1block-deployment>
    ...
    /// See: <https://specs.unstable.org/upgrades/ecotone/derivation#gaspriceoracle-deployment>
    ...
    pub fn deposits() -> impl Iterator<Item = TxDeposit> {
        ([
            ...
            // See: <https://specs.unstable.org/upgrades/ecotone/derivation#l1block-proxy-update>
            TxDeposit {
            ...
            // See: <https://specs.unstable.org/upgrades/ecotone/derivation#gaspriceoracle-proxy-update>
            TxDeposit {
            ...
            // See: <https://specs.unstable.org/upgrades/ecotone/derivation#gaspriceoracle-enable-ecotone>
            TxDeposit {
            ...
            // See: <https://specs.unstable.org/upgrades/ecotone/derivation#beacon-block-roots-contract-deployment-eip-4788>
            TxDeposit {
