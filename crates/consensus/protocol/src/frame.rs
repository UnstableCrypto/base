//! Frame types for Unstable L2 data transmission.
//!
//! Frames are the fundamental unit of data transmission in the Unstable derivation
...
///
/// Frames are the atomic units of data transmission in the Unstable derivation pipeline.
