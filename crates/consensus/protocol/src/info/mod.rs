...
//! splitting them in two, e.g.  `L1BlockInfoBedrockUnstable` and
...
//!
//! 1. `L1BlockInfoBedrockUnstable` < `L1BlockInfoEcotoneUnstable` < `L1BlockInfoIsthmus` < `L1BlockInfoJovian`
//! 2. `L1BlockInfoBedrockUnstable` < `L1BlockInfoBedrock`
//! 3. `L1BlockInfoEcotoneUnstable` < `L1BlockInfoEcotone`
...
mod bedrock_base;
pub use bedrock_base::{L1BlockInfoBedrockUnstable, L1BlockInfoBedrockUnstableFields};

mod ecotone;
pub use ecotone::{L1BlockInfoEcotone, L1BlockInfoEcotoneFields, L1BlockInfoEcotoneOnlyFields};

mod ecotone_base;
pub use ecotone_base::{L1BlockInfoEcotoneUnstable, L1BlockInfoEcotoneUnstableFields};

mod isthmus;
pub use isthmus::{L1BlockInfoIsthmus, L1BlockInfoIsthmusUnstableFields, L1BlockInfoIsthmusFields};

mod jovian;
pub use jovian::{L1BlockInfoJovian, L1BlockInfoJovianUnstableFields, L1BlockInfoJovianFields};
