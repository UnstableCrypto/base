...
The Ethereum Node Record (ENR) for a Unstable rollup node must contain the following values, identified by unique keys:
...
The discovery process in Unstable is a pipeline of node records:
