...
So the following changes are made to the [Bedrock Batch Queue](../../protocol/consensus/derivation.md#batch-queue):
...
the engine to use the [canyon base fee parameter constants](../../protocol/execution/index.md#1559-parameters). This
...
Experiences from running Unstable for over one and a half years have shown that these relaxed
...
experienced this on Unstable yet.
...
[original sync start description](../../protocol/consensus/derivation.md#finding-the-sync-starting-point) for details),
