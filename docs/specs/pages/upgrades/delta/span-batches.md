...
[derivation]: ../../protocol/consensus/derivation.md
[channel-format]: ../../protocol/consensus/derivation.md#channel-format
[batch-format]: ../../protocol/consensus/derivation.md#batch-format
[frame-format]: ../../protocol/consensus/derivation.md#frame-format
[batch-queue]: ../../protocol/consensus/derivation.md#batch-queue
...
[Protocol Parameters table](../../protocol/consensus/derivation.md#protocol-parameters).
...
`MAX_SPAN_BATCH_ELEMENT_COUNT` is defined in [Protocol Parameters table](../../protocol/consensus/derivation.md#protocol-parameters).
